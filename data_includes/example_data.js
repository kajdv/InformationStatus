        ...
        _init: function () {
         ...
         //   this.options.transfer = null; // Remove â€™click to continue messageâ€™.
            ...
            this.element.VBox({
             ...
             $("input[name=OldNewQuestion]").val(this.options.OldNewQuestion);
             ...
             $("p[name=q]").html(this.options.OldNewQuestion);
...
var items = GetItemsFrom(data, null, {
  ...
  Elements: [
      ...
      // LIKELY OLD      
          ...
          OldNewQuestion: function(row){ return row.OldNewQuestion; }, 
          ...
          leftScale: function(row){return "It is <b>not likely</b> ";},
          rightScale: function(row){return "<b>very likely</b>";},      
          id: id
      }   
  ]
